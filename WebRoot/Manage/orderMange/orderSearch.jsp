...
session.setAttribute("THIS", "orderMange/orderMain.jsp");
  ...
  String dStade=request.getParameter("dStade");
    DingdansDao dao=new DingdansDao();  //调用方法，显示当前页，每页显示10条
  List<DingdansInfo> list =  dao.getDingdan2(currPages,dStade);
...
<%}else if(currPages==1){ //如果是首页 %> 
 <div align="center">首页  &nbsp;上一页 &nbsp;  <a href="orderSearch.jsp?pages=<%=currPages+1%>">下一页</a>&nbsp; <a href="orderSearch.jsp?pages=<%=n%>">末页</a></div>
 <%
}else if(currPages==n){  //如果是末页
 %>
 <div align="center"><a href="orderSearch.jsp?pages=1">首页</a>  &nbsp;<a href="orderSearch.jsp?pages=<%=currPages-1%>">上一页</a> &nbsp;  下一页 &nbsp; 末页 </div>
 <%}else{ %>
 <div align="center"><a href="orderSearch.jsp?pages=1">首页</a>  &nbsp;<a href="orderSearch.jsp?pages=<%=currPages-1%>">上一页</a> &nbsp;  <a href="orderSearch.jsp?pages=<%=currPages+1%>">下一页</a>&nbsp; <a href="orderSearch.jsp?pages=<%=n%>">末页</a></div>
 <%} %><br/>
