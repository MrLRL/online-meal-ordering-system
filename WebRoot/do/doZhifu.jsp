...
//支付功能（作者：周华）
  ...
  double price=cart.sum(user.getuId());
  //计算新余额
  ...
  //获得购物车信息并添加到详情表，然后清空
List<CartsInfo> list=cart.getCartInfo(user.getuId()); 
if(list!=null){
for(int i=0;i<list.size();i++){
 CartsInfo info=list.get(i);
  DetailsInfo de=new DetailsInfo(null,info.getgCount(),info.getgId(),dd2.getdId(),info.getcBeizhu());
 ...
 cart.clearCart(user.getuId());//清空购物车
